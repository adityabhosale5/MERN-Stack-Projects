...
export default function NewFriendReq({currentUser, newFButton, setNewFButton}){
        ...
        <Container>
            <div className="header">
                <div className="text">
                    ...
                    <h3>Accept Request to become friends</h3>
                </div>
                    
                <button className="btn3" onClick={() => {setNewFButton(!newFButton);}}>
                    <IoCloseSharp />
                </button>
            </div>
